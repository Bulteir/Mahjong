...
.SetEnvironmentName("Test");
    ...
    //IAP başarılı şekilde başlatıldığında girer
    ...
    //IAP başlatılmasında hata ile karşılaşılırsa
    ...
    //Satın almada hata meydana gelirse
...
.SetEnvironmentName("Test");
        ...
        if (storeController != null)
        {
            ...
            if (product != null)
            {
                if (product.hasReceipt)
                {
                    ...
                    if (saveFile.saveTime != null)//Kayıtlı save dosyası varsa
                    {
                    ...
                    Debug.Log("Daha önce satın aldığınız reklam yok ürünü geri getirildi.");
                }
                else
                {
    ...
    public void OnPurchaseFailed(Product product, PurchaseFailureDescription failureDescription)
    {
        ...
        Debug.Log("Satın almada hata meydana geldi. message:" + failureDescription.message + " reason:" + failureDescription.reason + " ıd:" + failureDescription.productId);

        if (product.hasReceipt)
        {
            Debug.Log("Daha önce satın alınmış. id:" + product.definition.id);
    ...
    //mağazadan bir ürün satın alındığında oyuna nasıl etki edecekse ayarlamalar yapılır.
